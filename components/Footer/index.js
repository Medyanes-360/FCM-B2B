...
function Footer() {
  ...
  return (
    <footer id="footer" className={`bg-CustomGray w-screen  ${currentUrl === "/customer-orders" ? 'lg:w-full' : 'lg:w-[1190px]'}`}>
      <div className="container mx-auto px-4 md:py-10 py-5 text-gray-300 ">
        ...
        {/* Adres */}
        <div className="flex justify-center items-center border-t border-gray-700 mt-8 pt-5">
          <iframe
            ...
            className="w-full md:w-3/5 lg:w-2/3 h-80"
            style={{ border: "0" }}
            allowFullScreen=""
            loading="lazy"
        ...
        {/* Not */}
        <div className="flex justify-center items-center text-center text-xs mt-8 text-gray-400">
